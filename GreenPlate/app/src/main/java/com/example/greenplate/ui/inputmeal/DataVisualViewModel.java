...
public class DataVisualViewModel {

    private static DataVisualViewModel instance;
    ...
    public static synchronized DataVisualViewModel getInstance() {
        if (instance == null) {
            instance = new DataVisualViewModel();
        }
        return instance;
    }
